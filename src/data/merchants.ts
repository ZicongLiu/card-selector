...
export const MERCHANTS: MerchantEntry[] = [
  ...
  // Whole Foods earns 5% via Freedom Flex rotating bonus Q2 2026
  { name: 'Whole Foods',  category: 'rotating', rotatingNote: '⚡ Q2 bonus: 5% with Freedom Flex' },
  ...
  // Online Shopping
  // Amazon earns 5% via Freedom Flex rotating bonus Q2 2026
  { name: 'Amazon',      category: 'rotating', rotatingNote: '⚡ Q2 bonus: 5% with Freedom Flex' },
...
export function getCategoryForMerchant(name: string): CategoryKey | null {
  const match = MERCHANTS.find((m) => m.name.toLowerCase() === name.toLowerCase());
